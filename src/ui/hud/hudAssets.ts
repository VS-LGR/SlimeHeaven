export const HUD_ASSETS = {
  ...
  iconMoon: "/assets/UI/UI_Icon_Moon.png",
  ...
  inventoryMinimized: "/assets/UI/Collepsed_Inventory.png",
  inventoryBackpackPanel: "/assets/UI/Backpack_UI.png",
  inventoryCompact: "/assets/UI/New_UI_Top_Right.png",
  inventoryExpanded: "/assets/UI/Expanded_Inventory.png",
  inventoryLargeCard: "/assets/UI/Large_Card_Inventory.png",
  inventoryWideCard: "/assets/UI/Wide_Card_Inventory.png",
  inventoryShortConfig: "/assets/UI/Short_Config.png",
  inventoryShortFavorite: "/assets/UI/Short_Favorite.png",
  inventoryShortList: "/assets/UI/Short_List.png",
  inventoryShortShowHide: "/assets/UI/Short_Show_Hide.png",
  inventoryShortArrow: "/assets/UI/Short_Arrow.png",
  inventoryArrow: "/assets/UI/Arrow_Icon.png",
  inventoryArrowBig: "/assets/UI/Arrow_Big_Icon.png",
  inventoryFood: "/assets/world/materials/Carrot.png",
  inventoryVine: "/assets/world/materials/Vine.png",
...
export const HUD_ASSET_FILES = {
  ...
  clock: "public/assets/UI/UI_Clock.png",
  ...
  iconMoon: "public/assets/UI/UI_Icon_Moon.png",
  ...
  inventoryMinimized: "public/assets/UI/Collepsed_Inventory.png",
  inventoryBackpackPanel: "public/assets/UI/Backpack_UI.png",
  inventoryCompact: "public/assets/UI/New_UI_Top_Right.png",
  inventoryExpanded: "public/assets/UI/Expanded_Inventory.png",
  inventoryLargeCard: "public/assets/UI/Large_Card_Inventory.png",
  inventoryWideCard: "public/assets/UI/Wide_Card_Inventory.png",
  inventoryShortConfig: "public/assets/UI/Short_Config.png",
  inventoryShortFavorite: "public/assets/UI/Short_Favorite.png",
  inventoryShortList: "public/assets/UI/Short_List.png",
  inventoryShortShowHide: "public/assets/UI/Short_Show_Hide.png",
  inventoryShortArrow: "public/assets/UI/Short_Arrow.png",
  inventoryArrow: "public/assets/UI/Arrow_Icon.png",
  inventoryArrowBig: "public/assets/UI/Arrow_Big_Icon.png",
  inventoryFood: "public/assets/world/materials/Carrot.png",
  inventoryVine: "public/assets/world/materials/Vine.png",
...
export const HUD_ASSET_SIZES = {
  ...
  moon: { width: 112, height: 115 },
  slimeCard: { width: 368, height: 586 },
  star: { width: 76, height: 75 },
  inventoryMinimized: { width: 121, height: 102 },
  inventoryBackpackPanel: { width: 655, height: 561 },
  inventoryCompact: { width: 628, height: 130 },
  inventoryExpanded: { width: 598, height: 359 },
  inventoryLargeCard: { width: 84, height: 76 },
  inventoryWideCard: { width: 103, height: 35 },
  inventoryShort: { width: 37, height: 30 },
  inventoryShortConfig: { width: 37, height: 31 },
  inventoryArrow: { width: 31, height: 18 },
  inventoryArrowBig: { width: 31, height: 18 },
  inventoryFood: { width: 28, height: 27 },
  inventoryVine: { width: 47, height: 31 },
