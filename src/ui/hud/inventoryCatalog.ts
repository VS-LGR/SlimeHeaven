...
export const INVENTORY_ITEMS: Record<InventoryItemId, InventoryItemDefinition> = {
  ...
  copper_ore: {
    ...
    description: "Pedra bruta com veios de cobre. Ainda não entra no estoque da vila.",
  ...
  copper_ingot: {
    ...
    description: "Cobre fundido em barra. Catálogo apenas por enquanto.",
    acquired: "Ainda não coletável na vila.",
    usedIn: [],
    stockKey: null,
    optics: { boxScale: 0.9, offsetX: 0, offsetY: 1 },
  ...
  foliage: {
    ...
    description: "Folhas e ramos leves. Catálogo apenas por enquanto.",
    acquired: "Ainda não coletável na vila.",
    usedIn: [],
    stockKey: null,
